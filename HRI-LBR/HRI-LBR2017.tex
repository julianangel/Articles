...
. To fulfill all the requirements, the system was implemented in two different ROS nodes %TODO Here teh term node might be misleading. Maybe ROS node would be better
